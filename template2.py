...
class Template2(commands.Cog, name="template2"):
    ...
    async def addpress(self, context: Context, member: discord.Member):
        """
...
async def setup(bot):
    await bot.add_cog(Template2(bot))
